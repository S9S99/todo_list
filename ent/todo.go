...
type Todo struct {
	...
	Completed schema.Status `json:"completed,omitempty"`
...
func (*Todo) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case todo.FieldID, todo.FieldProgress:
			values[i] = new(sql.NullInt64)
		case todo.FieldTitle, todo.FieldTag, todo.FieldBody:
