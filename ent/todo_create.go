...
func (tc *TodoCreate) SetTag(s string) *TodoCreate {
...
func (tc *TodoCreate) SetCompleted(s schema.Status) *TodoCreate {
	tc.mutation.SetCompleted(s)
	return tc
}

// SetNillableCompleted sets the "completed" field if the given value is not nil.
func (tc *TodoCreate) SetNillableCompleted(s *schema.Status) *TodoCreate {
	if s != nil {
		tc.SetCompleted(*s)
	}
	return tc
...
func (tc *TodoCreate) SetProgress(u uint8) *TodoCreate {
	tc.mutation.SetProgress(u)
	return tc
}

// SetNillableProgress sets the "progress" field if the given value is not nil.
func (tc *TodoCreate) SetNillableProgress(u *uint8) *TodoCreate {
	if u != nil {
		tc.SetProgress(*u)
	}
	return tc
...
func (tc *TodoCreate) check() error {
	...
	if _, ok := tc.mutation.Tag(); !ok {
		return &ValidationError{Name: "tag", err: errors.New(`ent: missing required field "Todo.tag"`)}
	}
	if _, ok := tc.mutation.Progress(); !ok {
		return &ValidationError{Name: "progress", err: errors.New(`ent: missing required field "Todo.progress"`)}
	}
